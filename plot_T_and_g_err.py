...
plt.axhline(3, color = '0.5', ls = '--')
plt.axhline(-3, color = '0.5', ls = '--')

plt.savefig(path + 'errT_fit_vs_model_' + model + '.pdf', bbox_inches = 'tight')
...
axes1.set_xlim((0, 100000))
plt.savefig(path + 'errT_fit_vs_model_unzoom_' + model + '.pdf', bbox_inches = 'tight')
plt.show()
plt.close()
...
axes1.set_ylim((-100, 100))
axes1.set_xlim((6, 10))
plt.savefig(path + 'errg_fit_vs_model_unzoom_' + model + '.pdf', bbox_inches = 'tight')
