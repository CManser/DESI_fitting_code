...
ax1 = axes1.scatter(desi_T[wd_type == 1], T1[wd_type == 1], s=5, c= StN[wd_type == 1], vmin=0, vmax=30, cmap = cm, zorder = 100, edgecolor='')
plt.colorbar(ax1)
axes1.scatter(desi_T[wd_type == 1], T2[wd_type == 1], color = 'red', s=10, alpha = 0.1, edgecolor = '')
...
ax1 = plt.scatter(desi_T[wd_type == 1], 1 - (T1[wd_type == 1])/(desi_T[wd_type == 1]), c= StN[wd_type == 1], vmin=0, vmax=30, cmap = cm, s=5, zorder = 100, edgecolor='')
plt.colorbar(ax1)
plt.scatter(desi_T[wd_type == 1], 1 - (T2[wd_type == 1])/(desi_T[wd_type == 1]), color = 'red', s=10, alpha = 0.1, edgecolor='')
...
axes1.set_ylim((-0.25, 0.25))
axes1.set_xlim((0, 100000))
ax1 = plt.scatter(desi_T[(wd_type == 1) & (StN >= 10.)], 1 - (T1[(wd_type == 1) & (StN >= 10.)])/(desi_T[(wd_type == 1) & (StN >= 10.)]), c= StN[(wd_type == 1) & (StN >= 10.)], vmin=0, vmax=30, cmap = cm, s=5, zorder = 100, edgecolor='')
plt.colorbar(ax1)
plt.scatter(desi_T[(wd_type == 1) & (StN >= 10.)], 1 - (T2[(wd_type == 1) & (StN >= 10.)])/(desi_T[(wd_type == 1) & (StN >= 10.)]), color = 'red', s=10, alpha = 0.1, edgecolor='')
plt.axhline(0, color = '0.5', ls = '--')

plt.savefig(path + 'precentT_fit_vs_model_' + model + '_zoom_StN_10cut.pdf', bbox_inches = 'tight')
...
axes1.set_ylim((3, 10))
axes1.set_xlim((6, 10))
plt.scatter(desi_g[wd_type == 1], g1[wd_type == 1], s=5, c= StN[wd_type == 1], vmin=0, vmax=30, cmap = cm, zorder = 100, edgecolor='')
plt.colorbar(ax1)
plt.scatter(desi_g[wd_type == 1], g2[wd_type == 1], color = 'red', s=10, alpha = 0.1, edgecolor='')
x = np.arange(6, 11, 1)
...
axes1.set_xlim((6, 10))
axes1.set_ylim((-0.5, 0.5))
axes1.scatter(desi_g[wd_type == 1], 1 - (g1[wd_type == 1])/(desi_g[wd_type == 1]), s=5, c= StN[wd_type == 1], vmin=0, vmax=30, cmap = cm, zorder = 100, edgecolor='')
plt.colorbar(ax1)
axes1.scatter(desi_g[wd_type == 1], 1 - (g2[wd_type == 1])/(desi_g[wd_type == 1]), color = 'red', s=10, alpha = 0.1, edgecolor='')
...
axes1.set_ylabel(r'1 - $\frac{g_{obs}}{g_{model}}$')
axes1.set_xlabel("Model logg")
axes1.scatter(desi_g[(wd_type == 1) & (StN >= 10.)], 1 - (g1[(wd_type == 1) & (StN >= 10.)])/(desi_g[(wd_type == 1) & (StN >= 10.)]), s=5, c= StN[(wd_type == 1) & (StN >= 10.)], vmin=0, vmax=30, cmap = cm, zorder = 100, edgecolor='')
plt.colorbar(ax1)
axes1.scatter(desi_g[(wd_type == 1) & (StN >= 10.)], 1 - (g2[(wd_type == 1) & (StN >= 10.)])/(desi_g[(wd_type == 1) & (StN >= 10.)]), color = 'red', s=10, alpha = 0.1, edgecolor='')
axes1.axhline(0, color = '0.5', ls = '--')
axes1.set_xlim((6, 10))
axes1.set_ylim((-0.25, 0.25))
plt.savefig(path + 'precentg_fit_vs_model_' + model + '_zoom_StN_10cut.pdf', bbox_inches = 'tight')
plt.show()
plt.close()



plt.scatter(desi_T, desi_g, s = 2, color = 'black')
ax1 = plt.scatter(T1, g1, c= StN, vmin=0, vmax=30, s = 2, zorder = 100, edgecolor='')
plt.colorbar(ax1)
plt.show()
plt.close()